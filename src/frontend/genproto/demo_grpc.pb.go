...
type RatingServiceClient interface {
	...
	AddRatings(ctx context.Context, in *AddRatingsRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *ratingServiceClient) GetRatings(ctx context.Context, in *GetRatingsRequest, opts ...grpc.CallOption) (*GetRatingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hipstershop.RatingService/GetRatings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ratingServiceClient) AddRatings(ctx context.Context, in *AddRatingsRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/hipstershop.RatingService/AddRatings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RatingService_GetRatings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.RatingService/GetRatings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RatingService_AddRatings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRatingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RatingServiceServer).AddRatings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.RatingService/AddRatings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatingServiceServer).AddRatings(ctx, req.(*AddRatingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RatingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddRatings",
			Handler:    _RatingService_AddRatings_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
